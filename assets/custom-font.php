...
/*
Plugin Name: MyFontsWebfontsKit #3757824
...
add_action( 'admin_init', array('MyFontsInstaller_3757824','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3757824','mffonts_loadupWebfonts' ));